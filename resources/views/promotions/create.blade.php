        ...
        <div class="card-body">
            <form method="POST" action="{{ route('promotions.store') }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="border p-2 rounded">
                            ...
                            <div class="form-row align-items-center mb-2">
                                ...
                                <div class="col-auto">
                                    <select name="sr_age_mode" class="form-control form-control-sm">
                                        <option value="max" {{ old('sr_age_mode','max')==='max' ? 'selected' : '' }}>≤</option>
                                        <option value="min" {{ old('sr_age_mode')==='min' ? 'selected' : '' }}>≥</option>
                                    </select>
                                </div>
                                <div class="col">
                                    <input type="number" name="sr_age_days" class="form-control form-control-sm" placeholder="hari" value="{{ old('sr_age_days') }}">
                                </div>
                            </div>
                            <div class="form-row align-items-center">
                                ...
                                <div class="col">
                                    <input type="number" name="sr_min_past_bookings" class="form-control form-control-sm" placeholder="jumlah" value="{{ old('sr_min_past_bookings') }}">
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="segment_rules" id="segment_rules" class="form-control @error('segment_rules') is-invalid @enderror" rows="3" placeholder='Contoh: {"new_customer": true, "max_days_since_registration": 7, "min_past_bookings": 2}'>{{ old('segment_rules') ? json_encode(old('segment_rules')) : '' }}</textarea>
