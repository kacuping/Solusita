                            ...
                            <tr>
                                ...
                                <td style="width:220px">
                                    <div class="d-flex align-items-center">
                                        @if(!empty($cat->image))
                                            <img src="{{ (Route::has('service-categories.image') ? route('service-categories.image', $cat) : Storage::url($cat->image)) }}?v={{ optional($cat->updated_at)->timestamp ?? time() }}" alt="{{ $cat->name }}" style="width:48px;height:48px;object-fit:cover;border-radius:8px;margin-right:8px;">
                                            @else
